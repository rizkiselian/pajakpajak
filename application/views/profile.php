  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?>assets/uploads/avatar/<?php echo $userdata['foto']; ?>" alt="User profile picture">
  ...
  <div class="col-md-9">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li><a href="#fotoprofil" data-toggle="tab">Foto Profil</a></li>
      ...
      <div class="tab-content">
        ...
        <div class="active tab-pane" id="settings">
          <form class="form-horizontal" action="<?php echo base_url('Profile/update') ?>" method="POST" enctype="multipart/form-data">
           ...
           <input type="hidden" class="form-control" id="id" placeholder="Username" name="id" value="<?php echo $userdata['id']; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nama_lengkap" placeholder="Name" name="nama_lengkap" value="<?php echo $userdata['nama_lengkap']; ?>">
              </div>
            </div>
